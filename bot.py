...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "Daily Practice 🕒":
        ...
        help_text = (
            "📖 <b>How to use:</b>\n\n"
            "1. <b>Custom Practice</b>: Select specific topics and patterns to learn new concepts.\n"
            "2. <b>Daily Practice</b>: Adaptive sessions based on your weaknesses and SRS.\n"
            "3. <b>Profile</b>: Check your mastery levels and accuracy.\n\n"
            "Questions are generated by AI (Groq) to match GMAT standards."
        )
