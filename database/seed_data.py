...
def seed_gmat_data():
    ...
    db.execute_query("INSERT INTO topics (category_id, name) VALUES (%s, %s) ON CONFLICT DO NOTHING", (quant_id, "Vedic Math"))
    res = db.execute_query("SELECT id FROM topics WHERE category_id = %s AND name = %s", (quant_id, "Vedic Math"))
