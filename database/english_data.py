...
VOCABULARY_ITEMS = [
    {"id": "v-001", "word": "mitigate", "part_of_speech": "verb", "definition": "To make less severe or intense; to moderate.", "contextual_meaning": "To reduce the impact of a negative outcome.", "example_sentence": "The company implemented controls to mitigate financial risk.", "business_example": "Diversification can mitigate portfolio volatility.", "synonyms": ["alleviate", "reduce", "lessen", "diminish"], "antonyms": ["aggravate", "intensify", "worsen"], "root_prefix_suffix": "Latin 'mitigare' (to soften)", "common_confusion": "Mitigate does not mean to eliminate completely.", "memory_aid": "MITIgate → MITI(gation) makes things MILDER.", "level": 2, "difficulty": 3},
    {"id": "v-002", "word": "proliferate", "part_of_speech": "verb", "definition": "To increase rapidly in number; to multiply.", "contextual_meaning": "To spread or grow quickly.", "example_sentence": "Startups have proliferated in the technology sector.", "business_example": "Digital payment methods have proliferated across developing economies.", "synonyms": ["multiply", "spread", "expand", "burgeon"], "antonyms": ["decline", "decrease", "diminish"], "root_prefix_suffix": "Latin 'proles' (offspring) + 'ferre' (to bear)", "common_confusion": "Proliferate implies rapid, widespread increase, not just gradual growth.", "memory_aid": "PROLIFIC + RATE = things appearing at a prolific rate.", "level": 2, "difficulty": 3},
    {"id": "v-003", "word": "exacerbate", "part_of_speech": "verb", "definition": "To make a problem, situation, or negative feeling worse.", "contextual_meaning": "To intensify or aggravate an existing issue.", "example_sentence": "The drought exacerbated the water shortage.", "business_example": "Supply chain disruptions exacerbated inflationary pressures.", "synonyms": ["worsen", "aggravate", "intensify", "compound"], "antonyms": ["alleviate", "mitigate", "ameliorate"], "root_prefix_suffix": "Latin 'exacerbare' (to irritate)", "common_confusion": "Exacerbate means to make worse, not to cause; the problem must already exist.", "memory_aid": "EX-AGGRAVATE → makes things WORSE.", "level": 2, "difficulty": 3},
    {"id": "v-004", "word": "ubiquitous", "part_of_speech": "adjective", "definition": "Present, appearing, or found everywhere.", "contextual_meaning": "So common that it seems to be everywhere.", "example_sentence": "Smartphones have become ubiquitous in modern society.", "business_example": "Cloud computing has become ubiquitous in enterprise infrastructure.", "synonyms": ["omnipresent", "pervasive", "universal", "widespread"], "antonyms": ["rare", "scarce", "uncommon"], "root_prefix_suffix": "Latin 'ubique' (everywhere)", "common_confusion": "Ubiquitous implies presence everywhere, not just common.", "memory_aid": "U-BIG-uitous: so BIG it's everywhere.", "level": 3, "difficulty": 4},
    {"id": "v-005", "word": "pragmatic", "part_of_speech": "adjective", "definition": "Dealing with things sensibly and realistically; practical rather than theoretical.", "contextual_meaning": "Focused on practical outcomes rather than ideals.", "example_sentence": "The CEO took a pragmatic approach to the restructuring.", "business_example": "A pragmatic negotiation strategy focuses on achievable concessions.", "synonyms": ["practical", "realistic", "sensible", "utilitarian"], "antonyms": ["idealistic", "theoretical", "impractical"], "root_prefix_suffix": "Greek 'pragma' (deed, act)", "common_confusion": "Pragmatic is not negative—it simply means practical, not cynical.", "memory_aid": "PRAGmatic → PRACTical.", "level": 2, "difficulty": 2},
    {"id": "v-006", "word": "dichotomy", "part_of_speech": "noun", "definition": "A division or contrast between two things that are opposed or entirely different.", "contextual_meaning": "A clear division into two contradictory groups or ideas.", "example_sentence": "The dichotomy between rich and poor is growing.", "business_example": "The dichotomy between short-term profits and long-term sustainability presents a governance challenge.", "synonyms": ["divide", "split", "contrast", "polarity"], "antonyms": ["unity", "convergence", "similarity"], "root_prefix_suffix": "Greek 'dicha' (in two) + 'tomos' (cutting)", "common_confusion": "A dichotomy is a sharp division, not a mild difference.", "memory_aid": "DI (two) + CUT = cutting into TWO.", "level": 3, "difficulty": 4},
    {"id": "v-007", "word": "inherent", "part_of_speech": "adjective", "definition": "Existing as a permanent, essential, or characteristic attribute.", "contextual_meaning": "Built-in or natural; not added from outside.", "example_sentence": "There are inherent risks in any investment.", "business_example": "The inherent volatility of emerging markets requires careful risk management.", "synonyms": ["intrinsic", "innate", "built-in", "fundamental"], "antonyms": ["extrinsic", "acquired", "external"], "root_prefix_suffix": "Latin 'inhaerere' (to stick in)", "common_confusion": "Inherent means naturally part of something, not just associated with it.", "memory_aid": "IN-HERE-nt: the quality is IN HERE, built right in.", "level": 2, "difficulty": 3},
    {"id": "v-008", "word": "empirical", "part_of_speech": "adjective", "definition": "Based on observation or experience rather than theory or pure logic.", "contextual_meaning": "Derived from real-world data and evidence.", "example_sentence": "The theory lacks empirical support.", "business_example": "Empirical evidence suggests that diverse teams outperform homogeneous ones.", "synonyms": ["observational", "experiential", "evidence-based", "practical"], "antonyms": ["theoretical", "hypothetical", "speculative"], "root_prefix_suffix": "Greek 'empeiria' (experience)", "common_confusion": "Empirical does not mean 'proven'—it means based on observation.", "memory_aid": "EMPIRical → like an EMPIRE built on real experience.", "level": 3, "difficulty": 3},
    {"id": "v-009", "word": "corroborate", "part_of_speech": "verb", "definition": "To confirm or give support to a statement, theory, or finding.", "contextual_meaning": "To provide additional evidence that supports a claim.", "example_sentence": "The witness corroborated the defendant's alibi.", "business_example": "Independent auditors corroborated the company's financial statements.", "synonyms": ["confirm", "verify", "substantiate", "validate"], "antonyms": ["contradict", "refute", "disprove"], "root_prefix_suffix": "Latin 'corroborare' (to strengthen)", "common_confusion": "Corroborate means to support with additional evidence, not to originate the claim.", "memory_aid": "CO-ROBUST-ate: make an argument more ROBUST.", "level": 3, "difficulty": 4},
    {"id": "v-010", "word": "anomaly", "part_of_speech": "noun", "definition": "Something that deviates from what is standard, normal, or expected.", "contextual_meaning": "An unusual occurrence or irregularity.", "example_sentence": "The warm winter was an anomaly in the region's weather patterns.", "business_example": "The quarterly earnings spike was an anomaly driven by a one-time asset sale.", "synonyms": ["irregularity", "deviation", "aberration", "outlier"], "antonyms": ["norm", "regularity", "standard"], "root_prefix_suffix": "Greek 'anomalos' (uneven, irregular)", "common_confusion": "An anomaly is not necessarily negative; it simply deviates from the norm.", "memory_aid": "A-NORMAL-y: NOT normal.", "level": 2, "difficulty": 2},
    {"id": "v-011", "word": "precipitate", "part_of_speech": "verb", "definition": "To cause something to happen suddenly, unexpectedly, or prematurely.", "contextual_meaning": "To trigger or bring about rapidly.", "example_sentence": "The scandal precipitated the CEO's resignation.", "business_example": "A credit downgrade can precipitate a liquidity crisis.", "synonyms": ["trigger", "spark", "hasten", "accelerate"], "antonyms": ["prevent", "delay", "hinder"], "root_prefix_suffix": "Latin 'praecipitare' (to throw headlong)", "common_confusion": "Precipitate (verb) means to cause suddenly; precipitate (adjective) means hasty.", "memory_aid": "PRECIPICE + ATE: like falling off a precipice—sudden and dramatic.", "level": 3, "difficulty": 4},
    {"id": "v-012", "word": "commensurate", "part_of_speech": "adjective", "definition": "Corresponding in size, extent, or degree; proportionate.", "contextual_meaning": "Matching or in proportion to something.", "example_sentence": "The salary is commensurate with experience.", "business_example": "Returns should be commensurate with the level of risk assumed.", "synonyms": ["proportionate", "corresponding", "equivalent", "appropriate"], "antonyms": ["disproportionate", "inadequate", "excessive"], "root_prefix_suffix": "Latin 'com-' (together) + 'mensurare' (to measure)", "common_confusion": "Commensurate means proportional, not equal.", "memory_aid": "CO-MEASURE-ate: measured TOGETHER to match.", "level": 3, "difficulty": 4},
    {"id": "v-013", "word": "disparate", "part_of_speech": "adjective", "definition": "Essentially different in kind; not able to be compared.", "contextual_meaning": "So different that comparison is difficult or inappropriate.", "example_sentence": "The two proposals address disparate issues.", "business_example": "The merger brought together disparate corporate cultures.", "synonyms": ["different", "dissimilar", "distinct", "divergent"], "antonyms": ["similar", "comparable", "alike"], "root_prefix_suffix": "Latin 'disparatus' (separated)", "common_confusion": "Disparate means fundamentally different, not just slightly different. Do not confuse with 'desperate.'", "memory_aid": "DIS-PAIR-ate: things that don't PAIR well because they're too different.", "level": 3, "difficulty": 3},
    {"id": "v-014", "word": "paradigm", "part_of_speech": "noun", "definition": "A typical example or pattern of something; a model or framework.", "contextual_meaning": "A dominant way of thinking or a standard framework.", "example_sentence": "The shift from print to digital represented a paradigm shift in media.", "business_example": "Agile development represents a new paradigm for software engineering.", "synonyms": ["model", "framework", "pattern", "archetype"], "antonyms": ["anomaly", "deviation"], "root_prefix_suffix": "Greek 'paradeigma' (pattern, example)", "common_confusion": "A paradigm is the entire framework of assumptions, not just a single example.", "memory_aid": "PARA-DIME: a dime is a model coin—paradigm is the model framework.", "level": 3, "difficulty": 3},
    {"id": "v-015", "word": "catalyst", "part_of_speech": "noun", "definition": "A person or thing that precipitates an event or change.", "contextual_meaning": "Something that triggers or accelerates change without being consumed by it.", "example_sentence": "The new CEO served as a catalyst for organizational transformation.", "business_example": "Low interest rates acted as a catalyst for the housing market boom.", "synonyms": ["trigger", "stimulus", "impetus", "spark"], "antonyms": ["inhibitor", "deterrent", "obstacle"], "root_prefix_suffix": "Greek 'katalysis' (dissolution)", "common_confusion": "In business context, a catalyst initiates change; in chemistry, it speeds up a reaction.", "memory_aid": "CAT-a-LYST: the CAT knocked something over and started a chain reaction.", "level": 2, "difficulty": 2},
    {"id": "v-016", "word": "tenuous", "part_of_speech": "adjective", "definition": "Very weak or slight; lacking substance or firmness.", "contextual_meaning": "Barely adequate or supported; fragile.", "example_sentence": "The connection between the two events is tenuous at best.", "business_example": "The company's claim to market leadership rests on tenuous evidence.", "synonyms": ["weak", "flimsy", "fragile", "insubstantial"], "antonyms": ["strong", "substantial", "robust"], "root_prefix_suffix": "Latin 'tenuis' (thin, slight)", "common_confusion": "Tenuous implies weakness or fragility, not necessarily falsity.", "memory_aid": "TEN-U-ous: as thin as a TENDON stretched too far.", "level": 3, "difficulty": 3},
    {"id": "v-017", "word": "pertinent", "part_of_speech": "adjective", "definition": "Relevant or applicable to a particular matter; apposite.", "contextual_meaning": "Directly related and useful to the topic at hand.", "example_sentence": "The lawyer raised several pertinent objections.", "business_example": "The consultant focused on the most pertinent market data.", "synonyms": ["relevant", "applicable", "appropriate", "germane"], "antonyms": ["irrelevant", "immaterial", "extraneous"], "root_prefix_suffix": "Latin 'pertinere' (to pertain to)", "common_confusion": "Pertinent is stronger than 'related'—it means directly relevant and important.", "memory_aid": "PERTAIN-ent: it PERTAINS to the topic.", "level": 2, "difficulty": 2},
    {"id": "v-018", "word": "ambiguous", "part_of_speech": "adjective", "definition": "Open to more than one interpretation; unclear or inexact.", "contextual_meaning": "Having multiple possible meanings; not definitive.", "example_sentence": "The contract language was deliberately ambiguous.", "business_example": "Ambiguous regulatory guidelines create compliance uncertainty.", "synonyms": ["vague", "unclear", "equivocal", "indeterminate"], "antonyms": ["clear", "unambiguous", "definitive", "explicit"], "root_prefix_suffix": "Latin 'ambiguus' (having two meanings, from 'ambi-' = both)", "common_confusion": "Ambiguous (multiple meanings) vs. Ambivalent (mixed feelings).", "memory_aid": "AMBI (both) + GUOUS: going BOTH ways in meaning.", "level": 2, "difficulty": 2},
    {"id": "v-019", "word": "circumvent", "part_of_speech": "verb", "definition": "To find a way around an obstacle or restriction.", "contextual_meaning": "To avoid or bypass, especially cleverly.", "example_sentence": "The company found ways to circumvent the trade restrictions.", "business_example": "Some firms attempt to circumvent regulations through offshore subsidiaries.", "synonyms": ["bypass", "evade", "sidestep", "avoid"], "antonyms": ["confront", "comply", "face"], "root_prefix_suffix": "Latin 'circum' (around) + 'venire' (to come)", "common_confusion": "Circumvent implies clever avoidance, not direct confrontation.", "memory_aid": "CIRCUM (circle around) + VENT: go AROUND the obstacle.", "level": 3, "difficulty": 3},
    {"id": "v-020", "word": "substantiate", "part_of_speech": "verb", "definition": "To provide evidence to support or prove the truth of a claim.", "contextual_meaning": "To back up with concrete proof.", "example_sentence": "The researcher could not substantiate her claims with data.", "business_example": "The plaintiff must substantiate damages with financial documentation.", "synonyms": ["verify", "confirm", "corroborate", "validate"], "antonyms": ["disprove", "refute", "invalidate"], "root_prefix_suffix": "Latin 'substantia' (substance, essence)", "common_confusion": "Substantiate means to provide proof, not just to believe something.", "memory_aid": "SUBSTANCE + ATE: give SUBSTANCE (proof) to a claim.", "level": 3, "difficulty": 3},
    {"id": "v-021", "word": "analogous", "part_of_speech": "adjective", "definition": "Comparable in certain respects; similar enough to allow comparison.", "contextual_meaning": "Similar in relevant ways, allowing a useful comparison.", "example_sentence": "The CEO drew an analogous comparison between the two market downturns.", "business_example": "The current supply chain crisis is analogous to the disruptions of 2020.", "synonyms": ["comparable", "similar", "parallel", "equivalent"], "antonyms": ["dissimilar", "different", "unrelated"], "root_prefix_suffix": "Greek 'analogia' (proportion)", "common_confusion": "Analogous means similar in certain respects, not identical.", "memory_aid": "ANALOG-ous: like an ANALOGY—similar but not the same.", "level": 3, "difficulty": 3},
    {"id": "v-022", "word": "preclude", "part_of_speech": "verb", "definition": "To prevent from happening; to make impossible.", "contextual_meaning": "To rule out or make something impossible in advance.", "example_sentence": "The heavy snowfall precluded any outdoor activities.", "business_example": "The non-compete clause precludes former employees from joining rival firms.", "synonyms": ["prevent", "rule out", "exclude", "prohibit"], "antonyms": ["allow", "permit", "enable"], "root_prefix_suffix": "Latin 'praecludere' (to close off)", "common_confusion": "Preclude means to make impossible, not just to discourage.", "memory_aid": "PRE-CLUDE (close): CLOSE the door BEFORE something can happen.", "level": 3, "difficulty": 3},
    {"id": "v-023", "word": "volatile", "part_of_speech": "adjective", "definition": "Liable to change rapidly and unpredictably, especially for the worse.", "contextual_meaning": "Subject to sudden, dramatic fluctuations.", "example_sentence": "The stock market has been particularly volatile this quarter.", "business_example": "Volatile commodity prices make budget forecasting challenging.", "synonyms": ["unstable", "unpredictable", "fluctuating", "erratic"], "antonyms": ["stable", "steady", "predictable"], "root_prefix_suffix": "Latin 'volatilis' (fleeting, from volare = to fly)", "common_confusion": "Volatile doesn't always mean dangerous—it means prone to rapid change.", "memory_aid": "VOLATILE = VOL (fly) = changes that FLY up and down.", "level": 2, "difficulty": 2},
    {"id": "v-024", "word": "alleviate", "part_of_speech": "verb", "definition": "To make suffering, a problem, or a deficiency less severe.", "contextual_meaning": "To partially reduce or relieve a negative condition.", "example_sentence": "The new policy aims to alleviate poverty in rural areas.", "business_example": "Automation can alleviate bottlenecks in the production process.", "synonyms": ["relieve", "ease", "mitigate", "reduce"], "antonyms": ["aggravate", "worsen", "exacerbate"], "root_prefix_suffix": "Latin 'alleviare' (to lighten)", "common_confusion": "Alleviate means to reduce, not to eliminate completely.", "memory_aid": "A-LEVER-iate: use a LEVER to LIGHTEN the burden.", "level": 2, "difficulty": 2},
    {"id": "v-025", "word": "conjecture", "part_of_speech": "noun/verb", "definition": "An opinion or conclusion formed on the basis of incomplete information; a guess.", "contextual_meaning": "An educated guess without full evidence.", "example_sentence": "The report is based on conjecture rather than facts.", "business_example": "Analysts' earnings estimates are often conjecture disguised as precision.", "synonyms": ["speculation", "hypothesis", "supposition", "guess"], "antonyms": ["fact", "certainty", "proof"], "root_prefix_suffix": "Latin 'conjectura' (interpretation, from con- + jacere = to throw together)", "common_confusion": "Conjecture is weaker than hypothesis—it has even less evidence.", "memory_aid": "CON-JECT-ure: THROW (ject) ideas TOGETHER to guess.", "level": 3, "difficulty": 3},
    {"id": "v-026", "word": "feasible", "part_of_speech": "adjective", "definition": "Possible and practical to do easily or conveniently.", "contextual_meaning": "Capable of being accomplished; workable.", "example_sentence": "The plan is technically feasible but financially challenging.", "business_example": "A feasibility study determines whether the proposed expansion is feasible.", "synonyms": ["possible", "practicable", "viable", "achievable"], "antonyms": ["impossible", "impracticable", "unfeasible"], "root_prefix_suffix": "Latin 'facere' (to do, make)", "common_confusion": "Feasible means possible and practical, not just theoretically possible.", "memory_aid": "FEAS-ible = able to be DONE (facere).", "level": 2, "difficulty": 2},
    {"id": "v-027", "word": "scrutinize", "part_of_speech": "verb", "definition": "To examine or inspect closely and thoroughly.", "contextual_meaning": "To look at something with intense, critical attention.", "example_sentence": "Investors scrutinized the company's quarterly earnings report.", "business_example": "Regulators scrutinize merger proposals for antitrust concerns.", "synonyms": ["examine", "inspect", "analyze", "investigate"], "antonyms": ["overlook", "ignore", "neglect"], "root_prefix_suffix": "Latin 'scrutinium' (close search)", "common_confusion": "Scrutinize implies careful, detailed examination—not a casual glance.", "memory_aid": "SCRUT-inize: look at something under a SCREW-tiny lens.", "level": 2, "difficulty": 2},
    {"id": "v-028", "word": "unprecedented", "part_of_speech": "adjective", "definition": "Never done or known before; without previous example.", "contextual_meaning": "Completely new; no historical precedent exists.", "example_sentence": "The pandemic caused unprecedented disruption to global supply chains.", "business_example": "The central bank took unprecedented measures to stabilize markets.", "synonyms": ["unparalleled", "unmatched", "novel", "extraordinary"], "antonyms": ["common", "ordinary", "precedented"], "root_prefix_suffix": "un- (not) + precedent (previous example)", "common_confusion": "Unprecedented means truly first-time, not just unusual or severe.", "memory_aid": "UN-PRECEDENT-ed: no PRECEDENT (previous case) exists.", "level": 2, "difficulty": 2},
    {"id": "v-029", "word": "ameliorate", "part_of_speech": "verb", "definition": "To make something bad or unsatisfactory better; to improve.", "contextual_meaning": "To improve a negative situation or condition.", "example_sentence": "The new legislation aims to ameliorate working conditions in factories.", "business_example": "The restructuring plan is designed to ameliorate the company's financial position.", "synonyms": ["improve", "better", "enhance", "upgrade"], "antonyms": ["worsen", "deteriorate", "degrade"], "root_prefix_suffix": "Latin 'melior' (better)", "common_confusion": "Ameliorate specifically means to improve a bad situation, not just any improvement.", "memory_aid": "A-MELIORATE = make things MELLOW (better).", "level": 3, "difficulty": 4},
    {"id": "v-030", "word": "cogent", "part_of_speech": "adjective", "definition": "Clear, logical, and convincing.", "contextual_meaning": "Persuasive through clarity and strength of reasoning.", "example_sentence": "She presented a cogent argument for increasing the marketing budget.", "business_example": "The consultant delivered a cogent analysis that convinced the board to proceed.", "synonyms": ["convincing", "compelling", "persuasive", "logical"], "antonyms": ["unconvincing", "weak", "illogical", "vague"], "root_prefix_suffix": "Latin 'cogere' (to compel, drive together)", "common_confusion": "Cogent implies logical persuasiveness, not emotional appeal.", "memory_aid": "CO-GENT: a GENT (gentleman) who argues with compelling logic.", "level": 3, "difficulty": 3},
]
