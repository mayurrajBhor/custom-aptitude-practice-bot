...
const DEFAULT_GMAT_VOCAB = [
  { word: "mitigate", category: "Argumentation & Logic", definition: "To make less severe, serious, or painful; to moderate.", level: 1, difficulty: 2, synonyms: ["alleviate", "attenuate", "palliate", "moderate"] },
  { word: "proliferate", category: "Business & Economics", definition: "To increase rapidly in number or multiply quickly.", level: 2, difficulty: 3, synonyms: ["burgeon", "multiply", "mushroom", "escalate"] },
  { word: "exacerbate", category: "Argumentation & Logic", definition: "To make a problem, situation, or negative feeling worse.", level: 2, difficulty: 3, synonyms: ["aggravate", "compound", "worsen", "intensify"] },
  { word: "ubiquitous", category: "Science & Methodology", definition: "Present, appearing, or found everywhere.", level: 3, difficulty: 4, synonyms: ["omnipresent", "pervasive", "universal", "widespread"] },
  { word: "pragmatic", category: "Author Tone & Attitude", definition: "Dealing with things sensibly and realistically based on practical considerations.", level: 1, difficulty: 2, synonyms: ["utilitarian", "expedient", "sensible", "down-to-earth"] },
  { word: "dichotomy", category: "Argumentation & Logic", definition: "A division or contrast between two things that are represented as being entirely opposed.", level: 3, difficulty: 4, synonyms: ["bifurcation", "polarity", "schism", "duality"] },
  { word: "inherent", category: "Science & Methodology", definition: "Existing in something as a permanent, essential, or characteristic attribute.", level: 2, difficulty: 3, synonyms: ["intrinsic", "innate", "immanent", "fundamental"] },
  { word: "empirical", category: "Science & Methodology", definition: "Based on, concerned with, or verifiable by observation or experience rather than theory.", level: 2, difficulty: 3, synonyms: ["observational", "experimental", "evidence-based", "factual"] },
  { word: "corroborate", category: "Argumentation & Logic", definition: "To confirm or give support to a statement, theory, or finding with independent evidence.", level: 2, difficulty: 3, synonyms: ["substantiate", "authenticate", "verify", "validate"] },
  { word: "anomaly", category: "Argumentation & Logic", definition: "Something that deviates from what is standard, normal, or expected.", level: 1, difficulty: 2, synonyms: ["aberration", "outlier", "irregularity", "inconsistency"] },
  { word: "precipitate", category: "Business & Economics", definition: "To cause an event or situation to happen suddenly, unexpectedly, or prematurely.", level: 3, difficulty: 4, synonyms: ["instigate", "catalyze", "spark", "hasten"] },
  { word: "commensurate", category: "Business & Economics", definition: "Corresponding in size, extent, amount, or degree; proportionate.", level: 3, difficulty: 4, synonyms: ["proportionate", "equivalent", "commensurable", "consistent"] },
  { word: "disparate", category: "Science & Methodology", definition: "Essentially different in kind; not allowing comparison.", level: 2, difficulty: 3, synonyms: ["divergent", "heterogeneous", "incompatible", "distinct"] },
  { word: "paradigm", category: "Science & Methodology", definition: "A typical example, pattern, or overarching conceptual framework.", level: 2, difficulty: 3, synonyms: ["archetype", "framework", "prototype", "benchmark"] },
  { word: "catalyst", category: "Business & Economics", definition: "A person or event that causes or accelerates change.", level: 1, difficulty: 2, synonyms: ["impetus", "spark", "stimulus", "incitement"] },
  { word: "tenuous", category: "Argumentation & Logic", definition: "Very weak, slight, or flimsy; lacking a sound basis.", level: 2, difficulty: 3, synonyms: ["shaky", "flimsy", "fragile", "insubstantial"] },
  { word: "pertinent", category: "Argumentation & Logic", definition: "Relevant or applicable to a particular matter; apposite.", level: 1, difficulty: 2, synonyms: ["germane", "apposite", "material", "relevant"] },
  { word: "ambiguous", category: "Argumentation & Logic", definition: "Open to more than one interpretation; having a double or unclear meaning.", level: 1, difficulty: 2, synonyms: ["equivocal", "vague", "opaque", "indeterminate"] },
  { word: "circumvent", category: "Business & Economics", definition: "To find a way around an obstacle or rule, especially by ingenuity or strategy.", level: 2, difficulty: 3, synonyms: ["bypass", "evade", "sidestep", "skirt"] },
  { word: "substantiate", category: "Argumentation & Logic", definition: "To provide evidence to support or prove the truth of a claim.", level: 2, difficulty: 3, synonyms: ["corroborate", "validate", "authenticate", "verify"] },
  { word: "analogous", category: "Argumentation & Logic", definition: "Comparable in certain respects, typically in a way that makes clearer the nature of the things compared.", level: 2, difficulty: 3, synonyms: ["comparable", "parallel", "cognate", "equivalent"] },
  { word: "preclude", category: "Argumentation & Logic", definition: "To prevent from happening; to make impossible.", level: 2, difficulty: 3, synonyms: ["forestall", "prohibit", "prevent", "rule out"] },
  { word: "volatile", category: "Business & Economics", definition: "Liable to change rapidly and unpredictably, especially for the worse.", level: 1, difficulty: 2, synonyms: ["erratic", "capricious", "turbulent", "fluctuating"] },
  { word: "alleviate", category: "Argumentation & Logic", definition: "To make suffering, a deficiency, or a problem less severe.", level: 1, difficulty: 2, synonyms: ["assuage", "palliate", "mitigate", "ease"] },
  { word: "conjecture", category: "Argumentation & Logic", definition: "An opinion or conclusion formed on the basis of incomplete information.", level: 2, difficulty: 3, synonyms: ["speculation", "surmise", "hypothesis", "presumption"] },
  { word: "feasible", category: "Business & Economics", definition: "Possible and practical to do easily or conveniently.", level: 1, difficulty: 2, synonyms: ["viable", "practicable", "workable", "achievable"] },
  { word: "scrutinize", category: "Author Tone & Attitude", definition: "To examine or inspect closely and thoroughly.", level: 1, difficulty: 2, synonyms: ["inspect", "dissect", "interrogate", "audit"] },
  { word: "unprecedented", category: "Author Tone & Attitude", definition: "Never done or known before; without previous example.", level: 1, difficulty: 2, synonyms: ["unparalleled", "novel", "unmatched", "singular"] },
  { word: "ameliorate", category: "Argumentation & Logic", definition: "To make something bad, unsatisfactory, or deficient better.", level: 3, difficulty: 4, synonyms: ["improve", "better", "upgrade", "remedy"] },
  { word: "cogent", category: "Argumentation & Logic", definition: "Clear, logical, and convincing.", level: 2, difficulty: 3, synonyms: ["compelling", "lucid", "persuasive", "unassailable"] },
  { word: "equivocal", category: "Argumentation & Logic", definition: "Open to more than one interpretation; ambiguous; uncertain.", level: 3, difficulty: 4, synonyms: ["ambiguous", "evasive", "indeterminate", "opaque"] },
  { word: "qualify", category: "Argumentation & Logic", definition: "To make a statement or assertion less absolute; to add reservations or limits.", level: 3, difficulty: 5, synonyms: ["restrict", "limit", "moderate", "delimit"] },
  { word: "discount", category: "Argumentation & Logic", definition: "To regard a possibility, fact, or claim as being unworthy of consideration or exaggerated.", level: 3, difficulty: 5, synonyms: ["dismiss", "disregard", "reject", "downplay"] },
  { word: "specious", category: "Argumentation & Logic", definition: "Superficially plausible, but actually wrong, deceptive, or fallacious.", level: 3, difficulty: 4, synonyms: ["fallacious", "spurious", "misleading", "sophistic"] },
  { word: "belie", category: "Argumentation & Logic", definition: "To fail to give a true notion or impression of; to disguise or contradict.", level: 3, difficulty: 5, synonyms: ["contradict", "disprove", "negate", "unmask"] },
  { word: "untenable", category: "Argumentation & Logic", definition: "Not able to be maintained or defended against attack or objection.", level: 2, difficulty: 3, synonyms: ["indefensible", "unsustainable", "flawed", "unjustifiable"] },
  { word: "tacit", category: "Argumentation & Logic", definition: "Understood or implied without being stated directly.", level: 3, difficulty: 4, synonyms: ["implicit", "unstated", "inferred", "unspoken"] },
  { word: "vitiate", category: "Argumentation & Logic", definition: "To spoil or impair the quality or efficiency of; to invalidate or make legally defective.", level: 3, difficulty: 5, synonyms: ["invalidate", "undermine", "nullify", "corrupt"] },
  { word: "postulate", category: "Argumentation & Logic", definition: "To suggest or assume the existence, fact, or truth of something as a basis for reasoning.", level: 2, difficulty: 3, synonyms: ["posit", "hypothesize", "premise", "presuppose"] },
  { word: "fallacious", category: "Argumentation & Logic", definition: "Based on a mistaken belief, unsound reasoning, or logical fallacy.", level: 2, difficulty: 3, synonyms: ["illogical", "specious", "flawed", "erroneous"] },
  { word: "concede", category: "Argumentation & Logic", definition: "To admit that something is true or valid after first denying or resisting it.", level: 2, difficulty: 3, synonyms: ["acknowledge", "admit", "grant", "yield"] },
  { word: "caveat", category: "Argumentation & Logic", definition: "A warning or proviso of specific stipulations, conditions, or limitations.", level: 2, difficulty: 3, synonyms: ["stipulation", "proviso", "qualification", "reservation"] },
  { word: "extrapolate", category: "Argumentation & Logic", definition: "To extend the application of a conclusion or method to an unknown situation by assuming that existing trends will continue.", level: 2, difficulty: 3, synonyms: ["project", "deduce", "generalize", "infer"] },
  { word: "delineate", category: "Argumentation & Logic", definition: "To describe or portray something precisely; to indicate the exact position of a border.", level: 2, difficulty: 3, synonyms: ["demarcate", "outline", "define", "detail"] },
  { word: "nuance", category: "Argumentation & Logic", definition: "A subtle distinction or variation in meaning, tone, or argument.", level: 2, difficulty: 3, synonyms: ["subtlety", "gradation", "refinement", "shade"] },
  { word: "conflate", category: "Argumentation & Logic", definition: "To combine two or more distinct concepts, texts, or ideas into one, often erroneously.", level: 3, difficulty: 4, synonyms: ["confuse", "merge", "blend", "amalgamate"] },
  { word: "tautological", category: "Argumentation & Logic", definition: "Needlessly repetitive; involving circular reasoning where the premise assumes the conclusion.", level: 3, difficulty: 4, synonyms: ["circular", "redundant", "pleonastic", "self-referential"] },
  { word: "reconcile", category: "Argumentation & Logic", definition: "To make two seemingly contradictory findings, statements, or beliefs consistent with each other.", level: 2, difficulty: 3, synonyms: ["harmonize", "accommodate", "resolve", "synthesize"] },
  { word: "obviate", category: "Argumentation & Logic", definition: "To remove a need or difficulty; to make unnecessary.", level: 3, difficulty: 4, synonyms: ["preclude", "eliminate", "render unnecessary", "forestall"] },
  { word: "preempt", category: "Argumentation & Logic", definition: "To take action in order to prevent an anticipated event from happening; forestall.", level: 2, difficulty: 3, synonyms: ["forestall", "anticipate", "head off", "preclude"] },
  { word: "contingent", category: "Argumentation & Logic", definition: "Subject to chance; dependent on conditions that are not yet certain.", level: 2, difficulty: 3, synonyms: ["conditional", "dependent", "qualified", "provisional"] },
  { word: "bolster", category: "Argumentation & Logic", definition: "To support or strengthen; to prop up.", level: 1, difficulty: 2, synonyms: ["buttress", "reinforce", "fortify", "substantiate"] },
  { word: "undermine", category: "Argumentation & Logic", definition: "To lessen the effectiveness, power, or ability of, especially gradually or insidiously.", level: 1, difficulty: 2, synonyms: ["subvert", "weaken", "erode", "compromise"] },
  { word: "disparage", category: "Author Tone & Attitude", definition: "To regard or represent as being of little worth; to belittle.", level: 2, difficulty: 3, synonyms: ["belittle", "denigrate", "deprecate", "deride"] },
  { word: "rationalize", category: "Argumentation & Logic", definition: "To attempt to explain or justify a behavior or attitude with logical reasons, even if these are not appropriate.", level: 2, difficulty: 3, synonyms: ["justify", "defend", "streamline", "explain away"] },
  { word: "ambivalent", category: "Author Tone & Attitude", definition: "Having mixed feelings or contradictory ideas about something or someone.", level: 2, difficulty: 3, synonyms: ["conflicted", "equivocal", "undecided", "vacillating"] },
  { word: "guarded", category: "Author Tone & Attitude", definition: "Cautious and having possible reservations; not giving away much information.", level: 2, difficulty: 3, synonyms: ["circumspect", "cautious", "tentative", "hedged"] },
  { word: "skeptical", category: "Author Tone & Attitude", definition: "Not easily convinced; having doubts or reservations.", level: 1, difficulty: 2, synonyms: ["dubious", "incredulous", "disbelieving", "scrutinizing"] },
  { word: "emphatic", category: "Author Tone & Attitude", definition: "Expressing something forcibly and clearly.", level: 2, difficulty: 3, synonyms: ["assertive", "forceful", "categorical", "unequivocal"] },
  { word: "indifferent", category: "Author Tone & Attitude", definition: "Having no particular interest or sympathy; unconcerned.", level: 1, difficulty: 2, synonyms: ["apathetic", "unconcerned", "nonchalant", "disinterested"] },
  { word: "tentative", category: "Author Tone & Attitude", definition: "Not certain or fixed; provisional; done without confidence.", level: 2, difficulty: 3, synonyms: ["provisional", "conjectural", "exploratory", "hedged"] },
  { word: "candid", category: "Author Tone & Attitude", definition: "Truthful and straightforward; frank.", level: 2, difficulty: 3, synonyms: ["frank", "forthright", "unfiltered", "unreserved"] },
  { word: "derisive", category: "Author Tone & Attitude", definition: "Expressing contempt or ridicule; mocking.", level: 3, difficulty: 4, synonyms: ["scornful", "mocking", "disdainful", "sarcastic"] },
  { word: "deferential", category: "Author Tone & Attitude", definition: "Showing humble submission and deep respect.", level: 3, difficulty: 4, synonyms: ["respectful", "reverent", "courteous", "submissive"] },
  { word: "prudent", category: "Author Tone & Attitude", definition: "Acting with or showing care and thought for the future; discreet or cautious.", level: 2, difficulty: 3, synonyms: ["judicious", "circumspect", "sagacious", "wary"] },
  { word: "vehement", category: "Author Tone & Attitude", definition: "Showing strong feeling; forceful, passionate, or intense.", level: 3, difficulty: 4, synonyms: ["fervent", "passionate", "forceful", "strident"] },
  { word: "partisan", category: "Author Tone & Attitude", definition: "Prejudiced in favor of a particular cause, faction, or political bias.", level: 2, difficulty: 3, synonyms: ["biased", "sectarian", "prejudiced", "fractional"] },
  { word: "dispassionate", category: "Author Tone & Attitude", definition: "Not influenced by strong emotion, and so able to be rational and impartial.", level: 2, difficulty: 3, synonyms: ["impartial", "unbiased", "objective", "detached"] },
  { word: "patronizing", category: "Author Tone & Attitude", definition: "Treating someone with an apparent kindness that betrays a feeling of superiority; condescending.", level: 3, difficulty: 4, synonyms: ["condescending", "supercilious", "disdainful", "haughty"] },
  { word: "caustic", category: "Author Tone & Attitude", definition: "Sarcastic in a scathing and bitter way; chemically able to burn or corrode.", level: 3, difficulty: 4, synonyms: ["scathing", "mordant", "trenchant", "acerbic"] },
  { word: "nostalgic", category: "Author Tone & Attitude", definition: "Characterized by or exhibiting a sentimental longing or wistful affection for the past.", level: 1, difficulty: 2, synonyms: ["wistful", "sentimental", "retrospective", "evocative"] },
  { word: "strident", category: "Author Tone & Attitude", definition: "Loud, harsh, grating; presenting a controversial point of view in an unpleasantly forceful way.", level: 3, difficulty: 4, synonyms: ["shrill", "clamorous", "vociferous", "uncompromising"] },
  { word: "complacent", category: "Author Tone & Attitude", definition: "Showing smug or uncritical satisfaction with oneself or one's achievements.", level: 2, difficulty: 3, synonyms: ["self-satisfied", "smug", "heedless", "unconcerned"] },
  { word: "incredulous", category: "Author Tone & Attitude", definition: "Unwilling or unable to believe something; skeptical in disbelief.", level: 2, difficulty: 3, synonyms: ["disbelieving", "distrustful", "astonished", "unconvinced"] },
  { word: "amortize", category: "Business & Economics", definition: "To gradually write off the initial cost of an asset or repay a debt over a period.", level: 2, difficulty: 3, synonyms: ["write off", "depreciate", "liquidate debt", "expend over time"] },
  { word: "oligopoly", category: "Business & Economics", definition: "A state of limited competition, in which a market is shared by a small number of producers.", level: 2, difficulty: 3, synonyms: ["cartel", "concentrated market", "limited competition"] },
  { word: "solvency", category: "Business & Economics", definition: "The possession of assets in excess of liabilities; ability to pay one's long-term debts.", level: 2, difficulty: 3, synonyms: ["financial health", "stability", "creditworthiness"] },
  { word: "liquidity", category: "Business & Economics", definition: "The availability of liquid assets to a market or company; ease of converting assets into cash.", level: 2, difficulty: 3, synonyms: ["cash availability", "convertibility", "market depth"] },
  { word: "fiduciary", category: "Business & Economics", definition: "Involving trust, especially regarding the relationship between a trustee and a beneficiary.", level: 3, difficulty: 4, synonyms: ["trustee", "custodial", "ethical obligation", "fiduciary duty"] },
  { word: "arbitrage", category: "Business & Economics", definition: "The simultaneous purchase and sale of an asset in different markets to exploit price imbalances.", level: 3, difficulty: 4, synonyms: ["price spread trading", "market exploitation"] },
  { word: "fungible", category: "Business & Economics", definition: "Able to replace or be replaced by another identical item; mutually interchangeable.", level: 3, difficulty: 4, synonyms: ["interchangeable", "standardized", "equivalent", "commutable"] },
  { word: "hegemony", category: "Business & Economics", definition: "Leadership or dominance, especially by one country or social/economic group over others.", level: 3, difficulty: 5, synonyms: ["dominance", "supremacy", "ascendancy", "preponderance"] },
  { word: "equilibrium", category: "Business & Economics", definition: "A state in which opposing forces or influences are balanced.", level: 1, difficulty: 2, synonyms: ["balance", "stasis", "counterpoise", "symmetry"] },
  { word: "leverage", category: "Business & Economics", definition: "The ratio of debt to equity; or the power to influence a situation or people.", level: 2, difficulty: 3, synonyms: ["borrowed capital", "gearing", "bargaining power", "advantage"] },
  { word: "remuneration", category: "Business & Economics", definition: "Money paid for work or a service.", level: 2, difficulty: 3, synonyms: ["compensation", "stipend", "emolument", "salary"] },
  { word: "conglomerate", category: "Business & Economics", definition: "A multi-industry company that combines multiple diverse business entities under one corporate structure.", level: 2, difficulty: 3, synonyms: ["multinational", "syndicate", "consortium", "corporation"] },
  { word: "subsidy", category: "Business & Economics", definition: "A sum of money granted by the state or a public body to help an industry or business keep prices low.", level: 1, difficulty: 2, synonyms: ["grant", "subvention", "allowance", "bounty"] },
  { word: "propensity", category: "Business & Economics", definition: "An inclination or natural tendency to behave in a particular way.", level: 2, difficulty: 3, synonyms: ["predisposition", "proclivity", "inclination", "tendency"] },
  { word: "austerity", category: "Business & Economics", definition: "Difficult economic conditions created by government policies aimed at reducing public spending.", level: 2, difficulty: 3, synonyms: ["fiscal retrenchment", "stringency", "frugality", "parsimony"] },
  { word: "externality", category: "Business & Economics", definition: "A consequence of an industrial or commercial activity that affects other parties without being reflected in market cost.", level: 3, difficulty: 4, synonyms: ["side effect", "spillover effect", "unpriced consequence"] },
  { word: "rent-seeking", category: "Business & Economics", definition: "The practice of manipulating public policy or economic conditions to increase one's wealth without creating new wealth.", level: 3, difficulty: 5, synonyms: ["monopoly lobbying", "regulatory capture", "parasitic profit"] },
  { word: "incumbent", category: "Business & Economics", definition: "The holder of an office or post; or an established company currently holding dominant market share.", level: 1, difficulty: 2, synonyms: ["established leader", "market titan", "entrenched player"] },
  { word: "monopsony", category: "Business & Economics", definition: "A market situation in which there is only one buyer.", level: 3, difficulty: 5, synonyms: ["single-buyer market", "buyer monopoly"] },
  { word: "divestiture", category: "Business & Economics", definition: "The action or process of selling off subsidiary business interests or investments.", level: 2, difficulty: 3, synonyms: ["spin-off", "liquidation", "carve-out", "disposal"] },
  { word: "spurious", category: "Science & Methodology", definition: "Not being what it purports to be; false or fake.", level: 3, difficulty: 4, synonyms: ["specious", "bogus", "unauthentic", "illusory"] },
  { word: "causation", category: "Science & Methodology", definition: "The action of causing something; the relationship between cause and effect.", level: 1, difficulty: 2, synonyms: ["causality", "etiology", "origin", "provocation"] },
  { word: "confounding", category: "Science & Methodology", definition: "An extraneous variable in an experimental model that correlates with both the dependent and independent variables.", level: 3, difficulty: 4, synonyms: ["confusing", "distorting", "lurking variable", "extraneous"] },
  { word: "heuristic", category: "Science & Methodology", definition: "A mental shortcut or practical method that is not guaranteed to be optimal, but is sufficient for reaching an immediate goal.", level: 3, difficulty: 4, synonyms: ["rule of thumb", "cognitive shortcut", "practical method"] },
  { word: "synthesize", category: "Science & Methodology", definition: "To combine a number of things into a coherent whole.", level: 2, difficulty: 3, synonyms: ["amalgamate", "integrate", "harmonize", "consolidate"] },
  { word: "pervasive", category: "Science & Methodology", definition: "Spreading widely throughout an area or a group of people.", level: 2, difficulty: 3, synonyms: ["ubiquitous", "omnipresent", "permeating", "prevalent"] },
  { word: "endemic", category: "Science & Methodology", definition: "Regularly found among particular people or in a certain area; native or restricted.", level: 2, difficulty: 3, synonyms: ["indigenous", "native", "localized", "characteristic"] },
  { word: "latent", category: "Science & Methodology", definition: "Existing but not yet developed or manifest; hidden or concealed.", level: 2, difficulty: 3, synonyms: ["dormant", "quiescent", "unrealized", "covert"] },
  { word: "salient", category: "Science & Methodology", definition: "Most noticeable or important; prominent.", level: 2, difficulty: 3, synonyms: ["conspicuous", "prominent", "cardinal", "pivotal"] },
  { word: "ostensibly", category: "Argumentation & Logic", definition: "As appears or is stated to be true, though not necessarily so; apparently.", level: 3, difficulty: 4, synonyms: ["professedly", "apparently", "outwardly", "purportedly"] },
  { word: "deterministic", category: "Science & Methodology", definition: "Relating to the doctrine that all events are completely determined by previously existing causes.", level: 3, difficulty: 4, synonyms: ["mechanistic", "predetermined", "inevitable", "fated"] },
  { word: "immutable", category: "Science & Methodology", definition: "Unchanging over time or unable to be changed.", level: 2, difficulty: 3, synonyms: ["unalterable", "indelible", "permanent", "invariable"] },
  { word: "transient", category: "Science & Methodology", definition: "Lasting only for a short time; impermanent.", level: 2, difficulty: 3, synonyms: ["ephemeral", "fleeting", "evanescent", "fugitive"] },
  { word: "nascent", category: "Business & Economics", definition: "Just coming into existence and beginning to display signs of future potential.", level: 2, difficulty: 3, synonyms: ["incipient", "emerging", "embryonic", "fledgling"] },
  { word: "coalesce", category: "Science & Methodology", definition: "To come together to form one mass or whole.", level: 2, difficulty: 3, synonyms: ["merge", "consolidate", "fuse", "amalgamate"] },
  { word: "visceral", category: "Author Tone & Attitude", definition: "Relating to deep inward feelings rather than to the intellect.", level: 3, difficulty: 4, synonyms: ["instinctive", "gut-level", "primal", "non-rational"] },
  { word: "cognitive", category: "Science & Methodology", definition: "Relating to the mental action or process of acquiring knowledge and understanding through thought and experience.", level: 1, difficulty: 2, synonyms: ["intellectual", "mental", "cerebral", "rational"] },
  { word: "assuage", category: "Foundation Bridge", definition: "To make an unpleasant feeling less intense; to satisfy or appease.", level: 2, difficulty: 3, synonyms: ["placate", "mollify", "alleviate", "appease"] },
  { word: "lucid", category: "Foundation Bridge", definition: "Expressed clearly; easy to understand; completely intelligible.", level: 1, difficulty: 2, synonyms: ["articulate", "transparent", "coherent", "perspicuous"] },
  { word: "opaque", category: "Foundation Bridge", definition: "Not transparent; hard or impossible to understand.", level: 1, difficulty: 2, synonyms: ["inscrutable", "abstruse", "cryptic", "impenetrable"] },
  { word: "prodigal", category: "Foundation Bridge", definition: "Spending money or resources freely and recklessly; wastefully extravagant.", level: 3, difficulty: 4, synonyms: ["profligate", "spendthrift", "improvident", "extravagant"] },
  { word: "enigma", category: "Foundation Bridge", definition: "A person or thing that is mysterious, puzzling, or difficult to understand.", level: 1, difficulty: 2, synonyms: ["conundrum", "paradox", "puzzle", "riddle"] },
  { word: "fervid", category: "Foundation Bridge", definition: "Intensely enthusiastic or passionate, especially to an excessive degree.", level: 3, difficulty: 4, synonyms: ["ardent", "fervent", "impassioned", "zealous"] },
  { word: "placate", category: "Foundation Bridge", definition: "To make someone less angry or hostile; pacify.", level: 2, difficulty: 3, synonyms: ["conciliate", "propitiate", "mollify", "appease"] },
  { word: "laconic", category: "Foundation Bridge", definition: "Using very few words; concise to the point of seeming rude or mysterious.", level: 3, difficulty: 4, synonyms: ["terse", "succinct", "curt", "pithy"] },
  { word: "pedantic", category: "Foundation Bridge", definition: "Excessively concerned with minor details, formal rules, or displaying academic learning.", level: 3, difficulty: 4, synonyms: ["nitpicking", "scrupulous", "punctilious", "doctrinaire"] },
  { word: "vacillate", category: "Foundation Bridge", definition: "To alternate or waver between different opinions or actions; be indecisive.", level: 3, difficulty: 4, synonyms: ["dither", "oscillate", "waver", "hesitate"] },
  { word: "venerate", category: "Foundation Bridge", definition: "To regard with great respect; revere.", level: 2, difficulty: 3, synonyms: ["revere", "idolize", "esteem", "hallow"] },
  { word: "waver", category: "Foundation Bridge", definition: "To shake with a quivering motion; be undecided between two opinions or courses of action.", level: 1, difficulty: 2, synonyms: ["falter", "hesitate", "fluctuate", "totter"] },
  { word: "ephemeral", category: "Foundation Bridge", definition: "Lasting for a very short time; transitory.", level: 2, difficulty: 3, synonyms: ["transitory", "fleeting", "short-lived", "fugacious"] },
  { word: "garrulous", category: "Foundation Bridge", definition: "Excessively talkative, especially on trivial matters.", level: 3, difficulty: 4, synonyms: ["loquacious", "voluble", "verbose", "long-winded"] },
  { word: "arcane", category: "Foundation Bridge", definition: "Understood by few; mysterious or secret.", level: 2, difficulty: 3, synonyms: ["esoteric", "recondite", "abstruse", "inscrutable"] },
  { word: "convoluted", category: "Foundation Bridge", definition: "Extremely complex and difficult to follow; intricately folded.", level: 2, difficulty: 3, synonyms: ["tortuous", "byzantine", "labyrinthine", "tangled"] },
  { word: "reticent", category: "Foundation Bridge", definition: "Not revealing one's thoughts or feelings readily; reserved.", level: 2, difficulty: 3, synonyms: ["reserved", "uncommunicative", "taciturn", "guarded"] },
  { word: "meticulous", category: "Foundation Bridge", definition: "Showing great attention to detail; very careful and precise.", level: 1, difficulty: 2, synonyms: ["scrupulous", "punctilious", "painstaking", "rigorous"] },
  { word: "pernicious", category: "Foundation Bridge", definition: "Having a harmful effect, especially in a gradual or subtle way.", level: 3, difficulty: 4, synonyms: ["insidious", "deleterious", "detrimental", "ruinous"] },
  { word: "austere", category: "Foundation Bridge", definition: "Severe or strict in manner, attitude, or appearance; having no comforts or luxuries.", level: 2, difficulty: 3, synonyms: ["spartan", "ascetic", "unadorned", "rigorous"] }
];
